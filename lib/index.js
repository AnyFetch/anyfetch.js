...
module.exports = function(appId, appSecret, anyFetchServer, anyFetchFront) {
  ...
  this.API_FRONT = anyFetchFront || process.env.CLUESTR_FRONT || 'http://settings.anyfetch.com';
  this.API_ROOT = anyFetchServer || process.env.CLUESTR_SERVER || 'http://api.anyfetch.com';
