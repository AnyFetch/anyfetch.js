 ...
 * @param {string} (opt) replacement URL for cluestrServer
 * @param {string} (opt) replacement URL for cluestrFront
 */
module.exports = function(appId, appSecret, cluestrServer, cluestrFront) {
  ...
  this.API_FRONT = cluestrFront || process.env.CLUESTR_FRONT || 'http://settings.anyfetch.com';
